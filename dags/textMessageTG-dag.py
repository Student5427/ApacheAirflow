...
def send_currency_rate():
    ...
    #rates = response.json()
    message = "Тестовое сообщение для 2ой лабораторной по Apache Airflow"
...
dag = DAG('telegram_text_dag', default_args=default_args, schedule_interval='0 0,12 * * *',
           on_success_callback=dag_success_callback, on_failure_callback=dag_failure_callback)
